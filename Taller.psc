Algoritmo Taller
	...
	//Para entender las variables se utilizaron abreviados por ejemplo: en el
	//ejercicio "1" b_t (base del triangulo)
	//Sin embargo si nota algunas variables que llevan "variable_#" como por ejemplo: en el
	//ejercicio "2" d1_2 quiere decir que "d" es el nombre de un dato "1"es el dato numero 1 
	//y lo que le sigue "_2" es el numero del ejercicio 
